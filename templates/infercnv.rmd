...
ref_annots <- curr_params$infercnv$reference_celltypes %>% stringr::str_split(",") %>% unlist()
query_annots <- curr_params$infercnv$query_celltypes %>% stringr::str_split(",") %>% unlist()
...
for (sample in unique(seu@meta.data$sample)) {
  ...
  proceed <- any(grepl("malignant", infercnv_annots$infercnv_population))
