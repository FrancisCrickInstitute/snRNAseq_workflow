...
`r if (!("malignant" %in% SummarizedExperiment::colData(cds)$annotation)) { "inferCNV requires a malignant cluster as a query for CNV analysis, but the final celltype annotations do not include any 'malignant' cells. Please run the package again with a 'malignant' group specified in order to run inferCNV." }`
