---
title: "snRNAseq workflow: quality control"
...
knitr::opts_chunk$set(fig.align = "center",
                      dpi = 300, 
                      cache.path = paste0(curr_params$output$dir, "quality_control/quality_control_cache/"))
...
Output files will be saved to **`r curr_params$output$dir`/quality_control/`**.

Figures will be saved to **`r curr_params$output$dir`/quality_control/quality_control_files/figure-html/**.

Intermediate objects will be cached to **`r curr_params$output$dir`quality_control_cache/html/**.
...
```{r summary_statistics_plot, class.source = 'fold-hide', message = F, warning = F, fig.height = 5, fig.cap = "Plot of summary statistics by sample"}
p <-
  seu@meta.data %>%
  tibble::as_tibble() %>%
...
```{r save}
saveRDS(seu, "seu_quality_controlled.rds")
```
